...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name                     = "crowdunlocked-prod-public-${count.index + 1}"
...
resource "aws_eip" "nat" {
  ...
  tags = {
    Name = "crowdunlocked-prod-nat-${count.index + 1}"
  }
...
resource "aws_nat_gateway" "main" {
  ...
  tags = {
    Name = "crowdunlocked-prod-${count.index + 1}"
  }
...
resource "aws_route_table" "public" {
  ...
  tags = {
    Name = "crowdunlocked-prod-public"
  }
}
